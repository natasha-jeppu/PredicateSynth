...
(constraint (= (next 82 602 true ) 5))
(constraint (= (next 78 601 true ) 5))
(constraint (= (next 78 606 true ) 5))
(constraint (= (next 76 605 true ) 5))
(constraint (= (next 57 602 true ) 5))
(constraint (= (next 56 600 true ) 5))
(constraint (= (next 55 604 true ) 5))
(constraint (= (next 56 608 true ) 5))
(constraint (= (next 29 581 true ) 5))
(constraint (= (next 30 581 true ) 5))
(constraint (= (next 30 576 true ) 5))
