...
(constraint (= (inv prev_inp.temp rangeLow desiredTemperature allowedError) (and (not (> rangeLow prev_inp.temp)) (>= prev_inp.temp (- desiredTemperature allowedError)) (not (= prev_inp.temp (- desiredTemperature allowedError))))))
