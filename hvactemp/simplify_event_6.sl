...
(constraint (= (inv prev_inp.temp desiredTemperature allowedError) (and (not (> prev_inp.temp (+ desiredTemperature allowedError))) (not (>= prev_inp.temp (- desiredTemperature allowedError))))))
